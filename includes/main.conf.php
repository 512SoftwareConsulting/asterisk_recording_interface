...
#
# Asterisk Realtime
#   - path to config file.  Check and configures if in use.
#
$ASTERISK_EXTCONFIG_CONF = "/etc/asterisk/extconfig.conf";
...
#   option: Comma delimited list of module names (ie voicemail,callmonitor,broadcast,help,settings)
#
$ARI_ADMIN_MODULES = "broadcast";
